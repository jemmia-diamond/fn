...
import { haravanMoneyToNumber } from "services/haravan/webhook-order";
      ...
      try {
        await service.processOrder({
          ...
          customer: {
            ...
            first_name: order.customer_first_name ?? undefined,
            last_name: order.customer_last_name ?? undefined
          },
          total_price: haravanMoneyToNumber(order.total_price),
          subtotal_price: 0,
          total_discounts: haravanMoneyToNumber(order.total_discounts),
