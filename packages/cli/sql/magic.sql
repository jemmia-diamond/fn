...
CREATE SCHEMA advertising_cost;
...
CREATE SCHEMA conversation_rate;
...
CREATE SCHEMA dashboard_reporting;
...
CREATE SCHEMA inventory_report;
...
--
-- Name: diamond_quotation; Type: TABLE; Schema: supplychain; Owner: -
--

CREATE TABLE supplychain.diamond_quotation (
    id text NOT NULL,
    ticket_sent_time timestamp without time zone,
    sender_system text,
    stage text,
    description text,
    attachment jsonb,
...
--
-- Name: history_price_ticket; Type: TABLE; Schema: supplychain; Owner: -
--
...
--
-- Name: ticket_price; Type: TABLE; Schema: supplychain; Owner: -
--
...
CREATE TABLE supplychain.ticket_price (
    ...
    larkbasecreateat timestamp without time zone,
...
--
-- Name: diamond_quotation diamond_quotation_pkey; Type: CONSTRAINT; Schema: supplychain; Owner: -
--

ALTER TABLE ONLY supplychain.diamond_quotation
    ADD CONSTRAINT diamond_quotation_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY supplychain.diamond_ticket_quotation
    ADD CONSTRAINT diamond_ticket_quotation_pkey PRIMARY KEY (id);
...
--
-- Name: ticket_price ticket_price_pkey; Type: CONSTRAINT; Schema: supplychain; Owner: -
--

ALTER TABLE ONLY supplychain.ticket_price
...
--
-- Name: history_price_ticket trigger_set_created_at; Type: TRIGGER; Schema: supplychain; Owner: -
--

CREATE TRIGGER trigger_set_created_at BEFORE INSERT ON supplychain.history_price_ticket FOR EACH ROW EXECUTE FUNCTION supplychain.set_created_at();
...
--
-- Name: history_price_ticket trigger_set_updated_at; Type: TRIGGER; Schema: supplychain; Owner: -
--

CREATE TRIGGER trigger_set_updated_at BEFORE UPDATE ON supplychain.history_price_ticket FOR EACH ROW EXECUTE FUNCTION supplychain.set_updated_at();
