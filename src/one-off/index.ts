...
import updateWeddingRingPrices from "src/one-off/20260720_update_wedding_ring_prices";
...
export const ONE_OFF_SCRIPTS: Array<{ name: string; handler: (env: any) => Promise<void> }> = [
  ...
  { name: "20260720_update_wedding_ring_prices", handler: updateWeddingRingPrices }
];
