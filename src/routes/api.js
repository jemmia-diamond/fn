...
export default class APIRoutes {
  static register(api) {
    ...
    */
    ...
    ecommerceNamespaceApi.get("/ind-day-stats", Ecommerce.IndDayController.show);
    ecommerceNamespaceApi.delete("/ind-day-stats/reset", Ecommerce.IndDayController.destroy);
  };
};
