...
import type { ILarksuiteAppointment } from "src/services/larksuite/appointment/types";

export const saveAppointmentToPrismaDb = async (env: any, dataRequest: ILarksuiteAppointment) => {
