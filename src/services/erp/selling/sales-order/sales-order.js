...
export default class SalesOrderService {
  ...
  async processHaravanOrder(haravanOrderData) {
    ...
    const mappedOrderData = {
      ...
      payment_records: haravanOrderData.transactions.filter(transaction => ["capture", "authorization"].includes(transaction.kind.toLowerCase())).map(this.mapPaymentRecordFields),
