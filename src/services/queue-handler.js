  ...
  queue: async (batch, env) => {
    ...
    switch (batch.queue) {
      case "haravan-order-notification":
        await Ecommerce.OrderNotificationService.orderNotificationDequeue(
          batch,
          env
        );
        break;
      ...
      case "haravan-order-stock-control":
        await Haravan.OrderModule.OrderService.dequeueStockNotification(
          batch,
          env
        );
        break;
      case "haravan-order-transaction-sync":
        await Haravan.OrderModule.OrderService.dequeueTransactionSync(
          batch,
          env
        );
        break;
      case "haravan-order-product-quote-sync":
        await ProductQuote.ProductQuoteOrderService.dequeueOrderQueue(
          batch,
          env
        );
        break;
      ...
      case "pancake-pos-sync":
        ...
        break;
      case "message":
        await Pancake.ConversationService.dequeueMessageSyncCustomerToLeadCRM(
          batch,
          env
        );
        break;
      ...
      case "message-summary":
        await Pancake.ConversationService.dequeueMessageSummaryQueue(
          batch,
          env
        );
        break;
      case "pancake-message-last-interaction":
        await Pancake.ConversationService.dequeueMessageLastCustomerQueue(
          batch,
          env
        );
        break;
      case "customer-lens":
        await Pancake.ConversationService.dequeueMessageCustomerLensQueue(
          batch,
          env
        );
        break;
      case "pancake-sales-message":
        ...
        break;
      case "zalo-message":
        await Ecommerce.SendZaloMessage.dequeueSendZaloDeliveryMessageQueue(
          batch,
          env
        );
        await Ecommerce.SendZaloMessage.dequeueSendZaloConfirmMessageQueue(
          batch,
          env
        );
        await Ecommerce.SendZaloMessage.dequeueSendZaloRemindPayMessageQueue(
          batch,
          env
        );
        break;
      ...
      case "erpnext-sales-order":
        await ERP.Selling.SalesOrderService.dequeueSalesOrderNotificationQueue(
          batch,
          env
        );
        break;
      case "misa":
        await new Misa.MisaWebhookHandler(env).dequeueCallbackPayloadQueue(
          batch
        );
        break;
      case "erpnext-payment-entry":
        await ERP.Accounting.PaymentEntryService.dequeuePaymentEntryQueue(
          batch,
          env
        );
        break;
      ...
      case "sepay-transaction":
        await ERP.Accounting.SepayTransactionService.dequeueSaveToDb(
          batch,
          env
        );
        await ERP.Accounting.SepayTransactionService.dequeueSepayTransactionQueue(
          batch,
          env
        );
        break;
      case "haravan-product":
        await Haravan.Product.ProductVariantService.dequeueProductQueue(
          batch,
          env
        );
        await Haravan.Product.AutoAddToDiscountProgramService.dequeueProductQueue(
          batch,
          env
        );
        break;
      ...
      case "erpnext-selling":
        ...
        if (
          sellingMsg?.doctype === "SalesOrderItem" ||
          sellingMsg?.erpTopic === "update-sales-order-item"
        ) {
          await new ERP.Selling.SalesOrderItemService(
            env
          ).dequeueSalesOrderItemQueue(batch);
        } else {
          await new ERP.Selling.CustomerService(env).dequeueCustomerQueue(
            batch
          );
        }
        break;
